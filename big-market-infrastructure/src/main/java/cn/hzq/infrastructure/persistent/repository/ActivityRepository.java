...
public class ActivityRepository implements IActivityRepository {
    ...
    public void updateOrder(DeliveryOrderEntity deliveryOrderEntity) {
        ...
        try {
            ...
            raffleActivityAccountMonth.setMonth(raffleActivityAccountMonth.currentMonth());
            raffleActivityAccountMonth.setMonthCount(raffleActivityOrderRes.getDayCount());
            raffleActivityAccountMonth.setMonthCountSurplus(raffleActivityOrderRes.getDayCount());
            ...
            transactionTemplate.execute(status -> {
                try {
                    ...
                    status.setRollbackOnly();
                    log.error("写入订单记录，唯一索引冲突 userId:{} ,OutBusinessNo:{}", deliveryOrderEntity.getUserId(), deliveryOrderEntity.getOutBusinessNo(), e);
                    throw new AppException(ResponseCode.INDEX_DUP.getCode(), ResponseCode.INDEX_DUP.getInfo());
                }
            });
        } finally {
